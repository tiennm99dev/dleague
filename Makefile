...
.PHONY: help dev dev-debug build build-server web-install web-build web-dev \
        ...
        tools clean firebase-emulator seed-wordlists seed-wordlists-prod deploy deploy-staging
...
# embedded fallback. Requires MONGO_URI to be set.
# Usage: MONGO_URI=mongodb://localhost:27017 make seed-wordlists
seed-wordlists:
